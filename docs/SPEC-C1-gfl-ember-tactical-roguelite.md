...
- 오너가 카드·에셋 모듈의 가공·내장·배포 허가 확보를 확인했다. 코드 라이선스와 콘텐츠 허가는
  분리 기록하고, 공식 게임으로 오인시키는 표기를 하지 않는다.
...
| 원본 | SHA-256 |
|---|---|
| `소녀전선_잔불.png` | `9455A590066402D550C7CBEFE8E3D2DE0B0E5483D690A777A3794C42F8976DB5` |
| 에셋 모듈 1 | `7052BB0B908C0F781790A165DCF6C353C648084761AF1F4AD738F5F5E7D4433D` |
| 에셋 모듈 2 | `3C46BCFBEF53F6A0FA336335FB27EBA32814B1D54E325B4B1A89D9969854676A` |
| 에셋 모듈 3 | `8F7A559199C98A0C7793E859E8D401785D8586B5B58D0C53A7BA8ABDCC67C5B1` |
...
- manifest에 크기·해시·MIME·용도·출처를 기록.
...
1. 콘텐츠 허가 근거와 표기문을 별도 NOTICE에 기록.
2. 원본 해시와 12명·표정·배경·아이콘 selection manifest 고정.
3. LittleJS 1.18.24 라이선스·버전 provenance 기록.

완료 산출물: selection manifest, 권리 NOTICE, 원본·선택 보고서.
...
- C1 인형·보스 교체는 실제 에셋 누락이나 권리 문제 때만 하고 이유를 기록한다.
