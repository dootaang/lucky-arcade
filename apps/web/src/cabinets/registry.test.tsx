...
describe("public cabinet visibility", () => {
  it("derives public cabinets from the public Venue", () => {
    ...
    expect(listBuiltInCabinets().map((entry) => entry.manifest.id)).toEqual(["temerosa-high-low", "temerosa-blackjack", "temerosa-doubt", "temerosa-one-card", "temerosa-texas-holdem", "temerosa-slot", "indian-poker", "temerosa-old-maid", "temerosa-match-pairs"]);
