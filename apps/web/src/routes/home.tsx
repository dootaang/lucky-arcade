...
export function Home() {
  ...
  return <div className="app-layout">
    ...
    <main className="dashboard">
      <header className="topbar"><div aria-hidden="true" /><strong className="lobby-wallet">{balance.toLocaleString("ko-KR")} P</strong><button className="icon-button" onClick={() => setLight((value) => !value)} aria-label={light ? "어두운 테마" : "밝은 테마"}>{light ? <IconMoon /> : <IconSun />}</button></header>
