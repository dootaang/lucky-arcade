...
const rules = new Map([
  ...
  ["cabinets/five-card-draw", ["@lucky-arcade/card-table", "@lucky-arcade/engine", "@lucky-arcade/ui/playing-card", "@lucky-arcade/ui/card-stage", "@lucky-arcade/ui/card-stage.css"]],
