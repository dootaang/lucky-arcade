...
export const temerosaOldMaidCartridge: OldMaidCartridge = {
  ...
  characters: [
    ...
    { id: "bacikal", name: "바치칼", appearanceSet: "finale", tellStyle: "open", portraits: { neutral: "review-bacikal-standing", pleased: "review-bacikal-smile", tense: "review-bacikal-disappointed" } },
