...
export const restorationManifest: CabinetManifest = { id: "restoration-crew", version: RESTORATION_VERSION, title: "카드 복구반", description: "이름과 그림 사이의 이상한 부분을 찾아 원래 기록으로 복구합니다.", requiredCapabilities: ["distinct-npc-portraits>=4"] };
