...
export default function CasinoLedgerPanel({
  ...
  const npcBusinessIncomeToday=npcEconomyDetails?Object.values(npcEconomyDetails).reduce((sum,detail)=>sum+detail.grossIncomeToday,0):0;
